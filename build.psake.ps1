...
Task Package -depends Validate {
    Write-Host "The Package step should leverage a code package method that fits the project needs," -ForegroundColor Green

    Write-Host "Create the .nuspec file and pack the solution." -ForegroundColor Yellow
...
Task BuildValidatePublish -depends Build, Test, Publish {
